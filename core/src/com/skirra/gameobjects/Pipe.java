...
public class Pipe extends Scrollable {
    ...
    public Pipe(float x, float y, int width, int height, float scrollSpeed,
        ...
        // Initialize a Random object for Random number Gen
        r = new Random();
    ...
    public void update(float delta){
        ...
        // Our skull width is 24. The bar is only 22 px wide, so the skull
        // must be shifted by 1 px to the left (so that the skull is centered
